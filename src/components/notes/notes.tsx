...
import {addTagToFilter, removeTagFromFilter} from "../../store/notes/notes.action";
    ...
    return (
        <div className={style.notes}>
            <div className={style.tagFilter}>
                {tagFilter.map(tag => <span key={tag} className={style.tag}>
                    {tag}
                ...
                <Input placeholder='Введите тег' value={newTagFilterItem} onChange={(e: ChangeEvent<HTMLInputElement>) => {
