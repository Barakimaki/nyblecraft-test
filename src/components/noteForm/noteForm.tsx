        ...
        <form action="" className={style.form}>
            <div>
                <FormControl error={inputError} variant="standard">
                    <Input placeholder='Заголовок' defaultValue={title} onChange={(e: ChangeEvent<HTMLInputElement>) => {
                        setInputError(false)
                        setTitle(e.target.value)
                    }}/>
                    {inputError && <FormHelperText id="component-error-text">Заголовок не может быть пустым</FormHelperText>}
                </FormControl>
            </div>
